...
| `CCAR-P - Claude Certified Architect Professional/` | Architect – Professional | Parallel track — kept warm. Phases 0/2/4 closed, mock-exam engine built 2026-08-29, Papers 1-5 generated (Paper 5 most recent, 2026-09-02; D2 corpus expanded same day), none yet sat — see its own `ROADMAP.md` for the live stage |
