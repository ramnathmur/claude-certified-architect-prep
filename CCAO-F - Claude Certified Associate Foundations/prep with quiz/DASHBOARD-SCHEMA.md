...
| `format` | string | e.g. `FULL60` — set once the real item count is verified |
...
| `altitude_misses` | int \| null | Misses tagged `ALTITUDE` in the log — answers pitched more technical than the question asked for. Specific to this exam; see `EXAM-LOG.md` convention 8 |
...
```json
{"paper_n": 1, "format": "FULL60", "generated_date": "2026-09-01", "attempted_date": null, "score_source": null, "total_correct": null, "total_questions": 60, "estimated_scaled": null, "total_seconds": null, "single_answer": null, "multi_response": null, "domain_scores": null, "weakest_domain": null, "confirmed_weakness": null, "altitude_misses": null, "insight_round_due": false, "mode": "exam"}
```
...
5. `format` stays null-safe: do not write `FULL60` until the item count is confirmed from the official
   guide. The community figure of 60 is unverified.
