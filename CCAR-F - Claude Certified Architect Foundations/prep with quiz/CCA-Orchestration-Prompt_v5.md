<!--
  CCA-F Mock Exam Orchestration Prompt — v5
...
d. Seed questions: KDs first (priority: unused → partially-cycled → new cycle),
   ...
   seeded by a KD, prioritizing fresh v2 sections.
...
a.5 WRITE GENERATION-INTELLIGENCE.md update — overwrite the whole file (v4
   ...
   reflection ≥3 bullets), with one addition:
...
reason. Ends with confirmation gate.
