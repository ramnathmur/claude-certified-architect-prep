...
OUT = os.path.join(ROOT, "mock-exams", "CCA-Prep_MockTest-15_v1.html")
...
lines = [
    "  CCA-Prep Mock Test 15 -- CCA-F Foundations",
    ...
    "",
    "  SCENARIOS DRAWN (4 of the official 6) -- the only feasible unused combination containing both",
]
prim = {
...
lines += [
    "  scenarios Exam 14 rested. Rested here: Multi-Agent Research System, Claude Code for CI.",
    "  All six sat level at 8 draws after Exam 13, so rotation gave no tiebreaker; the never-used-set rule decided it.",
    "",
    ...
    "    833 prior stems (Exam 14 included); 0 intra-paper collisions; all 7 gates pass.",
    "    16 stems were rewritten after the gate caught them colliding with Exams 12-13 -- see PB-23.",
    "",
