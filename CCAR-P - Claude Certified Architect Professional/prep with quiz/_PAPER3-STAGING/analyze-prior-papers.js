#!/usr/bin/env node
/*
 * One-off analysis script for Paper 3 central planning. Extracts ITEMS from Papers 1 and 2's
 * shipped HTML (same extraction mechanism as tools/run-gate.js) and dumps ground-truth facet /
 * section / shape / direction / family / letter / objective usage to JSON. Per the Paper 3/4
 * generation prompt §3d, this is the ground truth for facet exclusion lists, not FACET-LEDGER.md's
 * own "used" column (which has a known gap).
 */
const fs = require("fs");
const vm = require("vm");
